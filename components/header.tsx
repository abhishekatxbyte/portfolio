  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        initial={{ y: 100, x: "-50%", opacity: 0 }} // Start from the bottom
        animate={{ y: 0, x: "-50%", opacity: 1 }} // Move to its final position
      ></motion.div>

      <nav className="flex fixed bottom-[1.7rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:bottom-[1.7rem] sm:h-[initial] sm:py-0">
